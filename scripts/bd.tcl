...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net scanout_0_video_out [get_bd_intf_ports video_out_0] [get_bd_intf_pins scanout_0/video_out]
  ...
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces rasterizer_0/Data_m_axi_gmem0] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces scanout_0/Data_m_axi_gmem1] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
